                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-9">
                        <div class="sub-content">
                            <section class="notice-list board-list"> <!-- 페이지명 클래스 -->
                                ...
                                <div class="section-content">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="subject">
                                                        <a href="/community/notice_view.php">공지사항 제목 노출 영역입니다.</a>
                                                    </td>
                                    ...
                                    <div class="btn-area">
                                        <p>
                                            <a href="/community/notice_write.php" class="btn btn-sm btn-blue" role="button">글쓰기</a>
                                        </p>
                                    </div>

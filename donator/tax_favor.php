...
<!--
                                                <li>
                                                    <dl>
                                                        <dt>개인 근로소득자</dt>
                                                        <dd>
                                                            소득세법에 의거 법정기부금으로 처리되어 기부금액의 15%(2,000만원 초과 기부 시 30%)를 세액공제 받으실 수 있습니다.
                                                        </dd>
                                                    </dl>
                                                </li>
                                                <li>
                                                    <dl>
                                                        <dt>개인 사업자</dt>
                                                        <dd>
                                                            종합소득세 신고 시 사업소득금액 100% 한도 내에서 전액 소득 공제되며, 초과분은 5년내 이월공제 (필요경비 또는 소득공제 중 선택 가능)
                                                        </dd>
                                                    </dl>
                                                </li>
-->
                                                <li>
                                                    <dl>
                                                        ...
                                                        <dd>
                                                            <ol>
                                                                <li>
                                                                    영리법인 : 법인세 신고 시 사업소득금액 50%한도 내에서 전액 소득 공제되며, 초과분은  5년내 이월공제
                                                                </li>
                                                                <li>
                                                                    비영리법인 : 고유목적사업준비금 사용액으로 인정  
                                                                </li>
                                                            </ol>
                                                        </dd>
                                                    </dl>
